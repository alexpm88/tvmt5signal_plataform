  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
      {cards.map((card, index) => (
        ...
        >
          {/* Outer glow effect */}
          <div className={cn("absolute inset-1 rounded-lg bg-gradient-to-br opacity-25 blur-3xl -z-2", card.color)} />
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  <p className="text-2xl font-bold text-slate-700">{card.value}</p>
                  <p
                    className={cn(
                      "text-sm font-medium",
